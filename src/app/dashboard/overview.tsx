...
export async function Overview() {
  ...
  const [unpaid, [{ remindersSent }]] = await Promise.all([
    db
    ...
    <div className="space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-4">
          {aging.map((a) => (
            ...
            >
              ...
              <p className={`mt-1 text-lg font-semibold ${toneClass[a.tone]}`}>
      ...
      {unpaid.length === 0 && (
        <p className="text-sm text-neutral-400">
          Sin facturas pendientes. Registra una en{" "}
          <a href="/dashboard/invoices" className="underline underline-offset-4">
            Facturas
          </a>
          .
        </p>
